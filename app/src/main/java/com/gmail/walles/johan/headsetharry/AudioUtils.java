...
public class AudioUtils {
    ...
    /**
     * @see AudioUtils#speakOverHeadset(Context, List, TtsUtils.CompletionListener)
     */
    private static class HeadsetSpeaker {
        ...
        public HeadsetSpeaker(Context context) {
         ...
         */
        public boolean speakOverHeadset(
    ...
    {
        return new HeadsetSpeaker(context).speakOverHeadset(announcement, completionListener);
    }
}
